...
final readonly class ContextStep implements ArtifactStepBase, StepBase
{
    public function __construct(private StepId $id, public string $inputKey)
    {
        if (trim($inputKey) === '') {
            throw new InvalidArgumentException('Context input key must not be empty.');
        }
    }
