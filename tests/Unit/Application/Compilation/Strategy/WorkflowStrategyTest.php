...
final class WorkflowStrategyTest extends TestCase
{
    ...
    public function test_it_rejects_a_workflow_without_resolve_as_the_first_step(): void
    {
        $this->expectException(WorkflowValidationException::class);
        $this->expectExceptionMessage('Workflow must start with RESOLVE.');

        $this->compile(new DomainWorkflowDefinition('invalid', '1.0.0', [
            new GenerateStep(
